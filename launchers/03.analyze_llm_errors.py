...
def main():
    ...
    # output_top_dir = Path('./outputs/03.analyze_llm_errors/20230711.refactor_distractors')

    # input_top_dir = Path('./outputs/12.evaluate_llm_proofs/2023-08-31.jpn/')
    # output_top_dir = Path('./outputs/03.analyze_llm_errors/2023-08-31.jpn/')

    # input_top_dir = Path('./outputs/12.evaluate_llm_proofs/20231106.refaactor/')
    # output_top_dir = Path('./outputs/03.analyze_llm_errors/20231106.refaactor/')

    # input_top_dir = Path('./outputs/12.evaluate_llm_proofs/20231107.preliminary/')
    # output_top_dir = Path('./outputs/03.analyze_llm_errors/20231107.preliminary/')

    input_top_dir = Path('./outputs/12.evaluate_llm_proofs/20231107.preliminary.many_samples/')
    output_top_dir = Path('./outputs/03.analyze_llm_errors/20231107.preliminary.many_samples/')

    # input_top_dir = Path('./outputs/12.evaluate_llm_proofs/20231107.preliminary.many_seeds/')
    # output_top_dir = Path('./outputs/03.analyze_llm_errors/20231107.preliminary.many_seeds/')
    ...
    logger.info('------------- ./03.analyze_llm_errors.py finished !! -----------')
