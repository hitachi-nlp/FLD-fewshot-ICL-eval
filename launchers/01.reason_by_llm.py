...
def main():
    ...
    # input_top_dir = Path('./outputs/10.make_prompts.py/20230701.refactor_distractors/dtst_nm=20230701.finalize.D3/prmpt_typ=in_context_examples.COT.v1/n_sht=10')
    # output_top_dir = Path('./outputs/01.reason_by_llm/20230701.refactor_distractors')

    # input_top_dir = Path('./outputs/10.make_prompts.py/2023-08-31.jpn/')
    # output_top_dir = Path('./outputs/01.reason_by_llm/2023-08-31.jpn/')

    # input_top_dir = Path('./outputs/10.make_prompts.py/20230905.LLM_FS/')
    # output_top_dir = Path('./outputs/01.reason_by_llm/20230905.LLM_FS/')

    # input_top_dir = Path('./outputs/10.make_prompts.py/20230919.jpn/')
    # output_top_dir = Path('./outputs/01.reason_by_llm/20230919.jpn/')

    # input_top_dir = Path('./outputs/10.make_prompts.py/20231106.refaactor/')
    # output_top_dir = Path('./outputs/01.reason_by_llm/20231106.refaactor/')

    # input_top_dir = Path('./outputs/10.make_prompts.py/20231106.preliminary/')
    # output_top_dir = Path('./outputs/01.reason_by_llm/20231106.preliminary/')

    # input_top_dir = Path('./outputs/10.make_prompts.py/20231107.preliminary/')
    # output_top_dir = Path('./outputs/01.reason_by_llm/20231107.preliminary/')

    # input_top_dir = Path('./outputs/10.make_prompts.py/20231107.preliminary/')
    # output_top_dir = Path('./outputs/01.reason_by_llm/20231107.preliminary.many_samples/')

    # input_top_dir = Path('./outputs/10.make_prompts.py/20231107.preliminary.seed--1/')
    # output_top_dir = Path('./outputs/01.reason_by_llm/20231107.preliminary.many_samples.seed--1')

    # input_top_dir = Path('./outputs/10.make_prompts.py/20231107.preliminary.seed--2/')
    # output_top_dir = Path('./outputs/01.reason_by_llm/20231107.preliminary.many_samples.seed--2')

    # input_top_dir = Path('./outputs/10.make_prompts.py/20231107.preliminary.many_seeds')
    # output_top_dir = Path('./outputs/01.reason_by_llm/20231107.preliminary.many_seeds')

    # input_top_dir = Path('./outputs/10.make_prompts.py/20231109.icl_max_proof_by_contradiction_per_label')
    # output_top_dir = Path('./outputs/01.reason_by_llm/20231109.icl_max_proof_by_contradiction_per_label')

    input_top_dir = Path('./outputs/10.make_prompts.py/20231109.3-shot')
    output_top_dir = Path('./outputs/01.reason_by_llm/20231109.3-shot')
    ...
    logger.info('------------- 01.reason_by_llm.py finished !! -----------')
